...
const HowItWorksPage: NextPage = () => {
    return (
        <div className="w-full relative bg-gosirat-light flex flex-col items-center pt-6 px-0 pb-0 box-border leading-normal tracking-normal">
            ...
            {/* Section 2 */}
            <section className="w-full py-20 px-4 mt-8 mb-16 border-y border-[rgba(0,0,0,0.05)]">
                <div className="max-w-7xl mx-auto flex flex-col gap-12">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 justify-center">
                        <div className="bg-white rounded-[22px] p-8 flex flex-col gap-4 h-full" data-aos="fade-up">
                        ...
                        <div className="bg-white rounded-[22px] p-8 flex flex-col gap-4 h-full" data-aos="fade-up" data-aos-delay="100">
                            <span className="text-4xl">🔐</span>
                        ...
                        <div className="bg-white rounded-[22px] p-8 flex flex-col gap-4 h-full" data-aos="fade-up" data-aos-delay="200">
                            <span className="text-4xl">📱</span>
