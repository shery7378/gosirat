        ...
        <div className="space-y-12 text-gray-700 leading-relaxed">
            ...
            <div className="bg-gray-50 border border-gray-200 rounded-xl p-8">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                    <a href="mailto:legal@gosirat.com" className="inline-flex items-center justify-center gap-2 bg-gosirat-green text-white px-6 py-3 rounded-lg font-medium hover:bg-gosirat-green-dark transition-colors">
                        📧 legal@gosirat.com
                    </a>
