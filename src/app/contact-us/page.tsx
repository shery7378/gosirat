...
export const metadata: Metadata = {
    title: "Contact GoSirat | School Transport Islamabad & Rawalpindi",
    description: "Contact GoSirat for safe school transportation and school pick-and-drop services. Get support, request information, or partner with us in Islamabad and Rawalpindi.",
    alternates: {
...
const ContactPage: NextPage = () => {
 return (
  <div className="rounded-[40px] max-w-full flex items-center flex-wrap content-center py-20 px-[70px] box-border gap-8 leading-[normal] tracking-[normal] mq750:gap-4 mq750:pl-[35px] mq750:pr-[35px] mq750:box-border">
   <WebPageSchema 
      title="Contact GoSirat | School Transport Islamabad & Rawalpindi" 
      description="Contact GoSirat for safe school transportation and school pick-and-drop services. Get support, request information, or partner with us in Islamabad and Rawalpindi." 
   ...
   <section className="h-[477px] flex-[1.0796] flex flex-col items-start justify-between gap-0 min-w-[335px] max-w-[508px] text-left text-[38px] text-[#101828] font-[Inter] mq450:gap-0 mq450:max-w-full">
    <div className="self-stretch flex flex-col items-start">
     <h1 className="m-0 self-stretch relative text-[length:inherit] leading-[46px] capitalize font-semibold font-[inherit] mq450:text-[23px] mq450:leading-7 mq750:text-3xl mq750:leading-[37px]">
     ...
     <div className="self-stretch min-h-[100px] h-auto rounded-xl border-[#176938] border-solid border-t-[1px] border-r-[1px] border-b-[1px] border-l-[6px] box-border overflow-hidden shrink-0 flex items-center pt-[23px] px-[18px] pb-[25px] max-w-full">
      <div className="flex-1 flex items-center gap-4 max-w-full mq450:items-start">
       ...
       <div className="flex-1 flex flex-col items-start gap-1.5 w-full max-w-full">
        ...
        <div className="self-stretch relative text-lg leading-6">
         Office No C-03, Bahrain Plaza Civic Centre, Bahria Town Phase 04, Islamabad
        </div>
       </div>
      </div>
     </div>
   ...
   <section className="flex-1 rounded-[10px] bg-[#f3f7f4] flex flex-col items-start justify-center p-7 box-border min-w-[335px] max-w-full text-left text-base text-[#bababa] font-[Inter] mq450:flex-1 mq450:pt-5 mq450:pb-5 mq450:box-border">
    <div className="self-stretch flex flex-col items-start gap-7 max-w-full">
     ...
     <button className="cursor-pointer [border:none] py-3 px-5 bg-[#176938] self-stretch rounded-xl flex flex-col items-center justify-center hover:bg-[#3d8f5e] transition-colors">
      <div className="w-36 relative text-2xl uppercase font-semibold font-[Inter] text-white-color text-center flex items-center justify-center mq450:text-[19px]">
       SUBMIT
      </div>
     </button>
    </div>
