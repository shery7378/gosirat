  ...
  <div className="w-full flex flex-col pt-16 pb-20 px-[70px] mq750:px-[35px] mq450:px-5 gap-12 bg-white">
   <WebPageSchema 
    ...
    <div className="rounded-[40px] max-w-full flex items-start flex-wrap content-center box-border gap-8 leading-[normal] tracking-[normal] mq750:gap-4">
     ...
     <section className="flex-1 rounded-[10px] bg-[#f3f7f4] flex flex-col items-start justify-center p-7 box-border min-w-[280px] w-full max-w-full text-left text-base text-[#bababa] font-[Inter] mq450:flex-1 mq450:pt-5 mq450:pb-5 mq450:box-border shadow-sm">
