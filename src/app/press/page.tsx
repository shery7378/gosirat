...
const PressPage: NextPage = () => {
    return (
        <div className="w-full relative bg-gosirat-light flex flex-col items-center pt-6 px-0 pb-0 box-border leading-normal tracking-normal overflow-hidden">
            <WebPageSchema 
                title="GoSirat Press | News, Media & School Transportation Updates" 
                description="Visit the GoSirat Press Center for company news, media inquiries, school transportation insights, safety updates, partnerships, and official brand resources." 
            ...
            <section className="w-full max-w-7xl mx-auto px-6 pt-16 pb-12 flex flex-col items-center text-center relative">
                <div className="rounded-full bg-gosirat-green-light/20 border border-[#89b99a]/40 flex items-center py-2 px-5 gap-2.5 mb-8" data-aos="fade-in">
                    <div className="h-2 w-2 rounded-full bg-gosirat-green-dark" />
                    <div className="tracking-[2px] leading-none uppercase font-bold text-gosirat-green-dark text-xs">
                        GoSirat Press & Media
                    </div>
                </div>
                
                <h1 className="m-0 font-sans font-semibold text-[64px] leading-[100%] tracking-normal text-center text-gosirat-black mb-8 max-w-5xl" data-aos="fade-up">
            ...
            <section className="w-full max-w-[1400px] mx-auto px-6 py-12 flex flex-col gap-16 md:gap-24">
                ...
                <div className="flex flex-col w-full" data-aos="fade-up">
                    <div className="text-center mb-10">
                        <span className="text-gosirat-green-alt font-semibold text-sm uppercase tracking-wider block mb-2">For Media Inquiries</span>
                        <h2 className="m-0 text-3xl md:text-4xl font-semibold text-gosirat-darker">Stories About Safer School Transportation</h2>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        <div className="bg-white rounded-[22px] p-8 border border-[rgba(0,0,0,0.1)] shadow-sm flex flex-col h-full hover:shadow-md transition-shadow">
                            ...
                            <h3 className="m-0 text-xl font-semibold text-gosirat-green-alt mb-4">School Transportation Safety Stories</h3>
                        ...
                        <div className="bg-white rounded-[22px] p-8 border border-[rgba(0,0,0,0.1)] shadow-sm flex flex-col h-full hover:shadow-md transition-shadow">
                            ...
                            <h3 className="m-0 text-xl font-semibold text-gosirat-green-alt mb-4">Safety & Technology Insights</h3>
                            <p className="m-0 text-gosirat-text leading-relaxed flex-1">
                        ...
                        <div className="bg-white rounded-[22px] p-8 border border-[rgba(0,0,0,0.1)] shadow-sm flex flex-col h-full hover:shadow-md transition-shadow">
                            <div className="text-3xl mb-4">📢</div>
                            <h3 className="m-0 text-xl font-semibold text-gosirat-green-alt mb-4">Company Announcements</h3>
                            <p className="m-0 text-gosirat-text leading-relaxed flex-1">
                        ...
                        <div className="bg-white rounded-[22px] p-8 border border-[rgba(0,0,0,0.1)] shadow-sm flex flex-col h-full hover:shadow-md transition-shadow">
                            <div className="text-3xl mb-4">🖼️</div>
                            <h3 className="m-0 text-xl font-semibold text-gosirat-green-alt mb-4">Brand Resources</h3>
                            <p className="m-0 text-gosirat-text leading-relaxed flex-1">
                ...
                <div className="flex flex-col w-full" data-aos="fade-up">
                    <div className="text-center mb-10">
                        <span className="text-gosirat-green-alt font-semibold text-sm uppercase tracking-wider block mb-2">For Partners</span>
                        <h2 className="m-0 text-3xl md:text-4xl font-semibold text-gosirat-darker">Building the Future of School Mobility Together</h2>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        <div className="bg-white rounded-[22px] p-8 border border-[rgba(0,0,0,0.1)] shadow-sm flex flex-col h-full hover:shadow-md transition-shadow">
                            <div className="text-3xl mb-4">🏫</div>
                            <h3 className="m-0 text-xl font-semibold text-gosirat-green-alt mb-4">School Partnerships</h3>
                            <p className="m-0 text-gosirat-text leading-relaxed flex-1">
                        ...
                        <div className="bg-white rounded-[22px] p-8 border border-[rgba(0,0,0,0.1)] shadow-sm flex flex-col h-full hover:shadow-md transition-shadow">
                            <div className="text-3xl mb-4">🚐</div>
                            <h3 className="m-0 text-xl font-semibold text-gosirat-green-alt mb-4">Driver Network Expansion</h3>
                            <p className="m-0 text-gosirat-text leading-relaxed flex-1">
                        ...
                        <div className="bg-white rounded-[22px] p-8 border border-[rgba(0,0,0,0.1)] shadow-sm flex flex-col h-full hover:shadow-md transition-shadow">
                            <div className="text-3xl mb-4">💻</div>
                            <h3 className="m-0 text-xl font-semibold text-gosirat-green-alt mb-4">Technology Partnerships</h3>
                            <p className="m-0 text-gosirat-text leading-relaxed flex-1">
                        ...
                        <div className="bg-white rounded-[22px] p-8 border border-[rgba(0,0,0,0.1)] shadow-sm flex flex-col h-full hover:shadow-md transition-shadow">
                            <div className="text-3xl mb-4">🌍</div>
                            <h3 className="m-0 text-xl font-semibold text-gosirat-green-alt mb-4">Community Initiatives</h3>
                            <p className="m-0 text-gosirat-text leading-relaxed flex-1">
                ...
                <div className="bg-gosirat-darker rounded-[32px] p-10 md:p-16 text-white relative overflow-hidden shadow-xl" data-aos="zoom-in">
                    ...
                    <div className="max-w-3xl mx-auto text-center flex flex-col items-center gap-6">
                        ...
                        <a href="mailto:info@gosirat.com" className="bg-gosirat-green-alt text-white font-semibold py-4 px-10 rounded-xl hover:bg-[#0a4f27] transition-all text-lg shadow-lg no-underline inline-block mt-4">
                            📩 info@gosirat.com
                        </a>
