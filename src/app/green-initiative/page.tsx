...
export default function EnvironmentPage() {
    return (
        <div className="w-full bg-[#f8fbf8] text-[#0c140f] font-inherit overflow-x-hidden">
            ...
            <section className="relative flex items-center justify-center text-center overflow-hidden min-h-[720px] h-screen">
                ...
                <div className="relative z-10 max-w-[820px] px-6 text-white flex flex-col items-center">
                    <div className="flex justify-center" data-aos="fade-in">
                        <div className="min-h-[29px] h-auto rounded-[30px] bg-[#f4f7f4]/5 border-[#f4f7f4]/20 border-solid border-[0.67px] box-border flex items-center py-[6px] px-[14px] gap-[8px]">
                            <div className="h-[6px] w-[6px] shrink-0 relative rounded-full bg-[#f4f7f4]" />
                            <div className="relative font-[Inter] font-medium text-[12px] leading-[16px] tracking-[1.68px] uppercase flex-1 text-center text-[#f4f7f4] break-words">
                                GoSirat Green Initiative
                            </div>
                        </div>
                    </div>
                    <h1 className="m-0 self-stretch relative font-[Inter] font-semibold text-[64px] leading-[100%] tracking-[0px] text-center text-[#F7F9F6] mq825:text-[51px] mq450:text-[38px] mt-[22px]" data-aos="fade-up" data-aos-delay="100">
                        Moving Every Child Toward a Cleaner Tomorrow
                    </h1>
                    <p className="self-stretch relative font-[Inter] font-normal text-[20px] leading-[32.5px] tracking-[0px] text-center text-[#f4f7f4]/80 mq450:text-base mq450:leading-[26px] mt-[22px] max-w-[800px] mx-auto" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div className="flex gap-4 justify-center mt-10 mq450:flex-col mq450:w-full" data-aos="fade-up" data-aos-delay="300">
                        <a href="#cta" className="no-underline rounded-2xl bg-gradient-to-r from-[#176938] to-[#2ecc71] flex items-center justify-center py-4 px-6 gap-[7px] cursor-pointer hover:shadow-lg hover:scale-[1.02] active:scale-95 transition-all duration-300 mq450:w-full">
                ...
                <div className="absolute bottom-[34px] left-1/2 -translate-x-1/2 z-10 text-[rgba(255,255,255,0.75)] flex flex-col items-center gap-2 font-[Inter] text-[11px] font-medium uppercase tracking-[.14em] animate-bounce">
                    <span>Scroll</span>
            ...
            <section className="bg-[#f8fbf8] py-[120px] lg:py-[80px] mq825:py-[60px] mq450:py-[50px]" id="why">
                <div className="w-full mx-auto px-8 lg:px-6 mq450:px-4">
                    <div className="grid grid-cols-2 mq825:grid-cols-1 gap-[72px] mq825:gap-[48px] items-center">
                        <div data-aos="fade-up">
                            ...
                            <div className="w-full relative font-[Inter] font-normal text-[20px] leading-[32.5px] tracking-[0px] text-left text-[#57605b] mt-[19.7px]">
            ...
            <section className="bg-white py-[120px] lg:py-[80px] mq825:py-[60px] mq450:py-[50px]" id="impact">
                <div className="max-w-[1240px] mx-auto px-8 lg:px-6 mq450:px-4">
                    <div className="max-w-[640px] mx-auto text-center mb-14" data-aos="fade-up">
                        ...
                        <div className="w-full relative font-[Inter] font-normal text-[20px] leading-[32.5px] tracking-[0px] text-center text-[#57605b] mt-[19.7px]">
            ...
            <section className="bg-[#0c140f] text-white py-[120px] lg:py-[80px] mq825:py-[60px] mq450:py-[50px]" id="commitment">
                <div className="max-w-[1240px] mx-auto px-8 lg:px-6 mq450:px-4">
                    <div className="max-w-[640px] mx-auto text-center mb-14" data-aos="fade-up">
                        <div className="flex justify-center">
                            <div className="min-h-[29px] h-auto rounded-[30px] bg-[#f4f7f4]/5 border-[#f4f7f4]/20 border-solid border-[0.67px] box-border flex items-center py-[6px] px-[14px] gap-[8px]">
                        ...
                        <h2 className="m-0 mt-6 self-stretch relative font-[Inter] font-semibold text-[48px] leading-none capitalize tracking-[-1.5px] text-center text-[#F7F9F6] mq825:text-[38px] mq825:leading-[48px] mq450:text-[24px] mq450:leading-[32px] break-words">
                            Our Commitment to a Sustainable Future
                        </h2>
                        <div className="w-full relative font-[Inter] font-normal text-[20px] leading-[32.5px] tracking-[0px] text-center text-[#f4f7f4]/80 mt-[19.7px]">
            ...
            <section className="bg-[#f8fbf8] py-[120px] lg:py-[80px] mq825:py-[60px] mq450:py-[50px]" id="stats">
                <div className="max-w-[1240px] mx-auto px-8 lg:px-6 mq450:px-4">
                    <div className="max-w-[640px] mx-auto text-center mb-14" data-aos="fade-up">
                        <div className="flex justify-center">
                            <div className="inline-flex rounded-[30px] bg-[rgba(213,240,219,0.4)] border-[rgba(23,105,56,0.15)] border-solid border-[0.67px] items-center py-[6px] px-[14px] gap-[8px]">
            ...
            <section className="relative min-h-[560px] flex items-center justify-center text-center overflow-hidden" id="cta">
                ...
                <div className="relative z-10 max-w-[640px] px-6 text-white" data-aos="fade-up">
                    ...
                    <div className="w-full relative font-[Inter] font-normal text-[20px] leading-[32.5px] tracking-[0px] text-center text-[#f4f7f4]/80 mt-[19.7px] max-w-[600px] mx-auto">
                    ...
                    <div className="flex justify-center mt-[34px] mq450:w-full">
                        <Link href="/register" className="no-underline rounded-2xl bg-gradient-to-r from-[#176938] to-[#2ecc71] flex items-center justify-center py-4 px-6 gap-[7px] cursor-pointer hover:shadow-lg hover:scale-[1.02] active:scale-95 transition-all duration-300 mq450:w-full">
                            <h3 className="m-0 relative text-[length:inherit] leading-5 font-medium font-[inherit] text-white">
                                Register Today
                            </h3>
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#F7F9F6" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M5 12h14M12 5l7 7-7 7" /></svg>
