...
export default function EnvironmentPage() {
    return (
        <div className="w-full bg-gosirat-bg-light text-gosirat-black font-inherit overflow-x-hidden">
            {/* ============ SECTION 1: HERO ============ */}
            <section className="relative flex items-center justify-center text-center overflow-hidden min-h-[720px] h-screen">
                ...
                <div className="relative z-10 max-w-[1200px] px-6 text-white flex flex-col items-center">
                    <div className="flex justify-center" data-aos="fade-in">
                        <div className="min-h-[29px] h-auto rounded-[30px] bg-gosirat-light/5 border-gosirat-light/20 border-solid border-[0.67px] box-border flex items-center py-[6px] px-[14px] gap-[8px]">
                            ...
                            <div className="relative font-sans font-medium text-[12px] leading-[16px] tracking-[1.68px] uppercase flex-1 text-center text-gosirat-light break-words">
                    ...
                    <div className="flex gap-4 justify-center mt-10 mq450:flex-col mq450:w-full" data-aos="fade-up" data-aos-delay="300">
                        <a href="#cta" className="no-underline rounded-2xl bg-gradient-to-r from-gosirat-green to-[#2ecc71] flex items-center justify-center py-4 px-6 gap-[7px] cursor-pointer hover:shadow-lg hover:scale-[1.02] active:scale-95 transition-all duration-300 mq450:w-full">
                            ...
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#F7F9F6" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M5 12h14M12 5l7 7-7 7" /></svg>
                        </a>
                        <a href="#why" className="no-underline rounded-2xl bg-[rgba(255,255,255,0.12)] border-[1.5px] border-[rgba(255,255,255,0.35)] backdrop-blur-[6px] flex items-center justify-center py-4 px-6 gap-[7px] cursor-pointer hover:bg-[rgba(255,255,255,0.2)] hover:scale-[1.02] active:scale-95 transition-all duration-300 mq450:w-full">
                            <h3 className="m-0 relative text-[length:inherit] leading-5 font-medium font-[inherit] text-white">
                                See How It Works
                            </h3>
                        </a>
                ...
                <div className="absolute bottom-[34px] left-1/2 -translate-x-1/2 z-10 text-[rgba(255,255,255,0.75)] flex flex-col items-center gap-2 font-sans text-[11px] font-medium uppercase tracking-[.14em] animate-bounce">
                    <span>Scroll</span>
            ...
            <section className="bg-gosirat-bg-light py-[120px] lg:py-[80px] mq825:py-[60px] mq450:py-[50px]" id="why">
                <div className="w-full mx-auto px-8 lg:px-6 mq450:px-4">
                    <div className="grid grid-cols-2 mq825:grid-cols-1 gap-[72px] mq825:gap-[48px] items-center">
                        <div data-aos="fade-up">
                            <div className="inline-flex rounded-[30px] bg-[rgba(213,240,219,0.4)] border-[rgba(23,105,56,0.15)] border-solid border-[0.67px] items-center py-[6px] px-[14px] gap-[8px]">
                            ...
                            <div className="w-full relative font-sans font-normal text-[20px] leading-[32.5px] tracking-normal text-left text-gosirat-gray mt-[19.7px]">
                            ...
                            <div className="grid grid-cols-2 mq825:grid-cols-1 gap-5 mt-10">
                                <div className="flex flex-col gap-3.5 p-5 rounded-[14px] border border-[rgba(23,105,56,0.15)] bg-white transition-all hover:-translate-y-1 hover:shadow-[0_1px_2px_rgba(14,27,22,0.04),_0_12px_32px_-12px_rgba(14,27,22,0.12)] hover:border-transparent">
                                    <div className="w-11 h-11 rounded-xl flex items-center justify-center bg-[rgba(213,240,219,0.4)] text-gosirat-green shrink-0">
                                    ...
                                    <h4 className="text-[15px] text-gosirat-black font-semibold leading-[1.1]">Reduced Emissions</h4>
                                    <p className="text-[13.5px] text-gosirat-gray leading-[1.55]">Fewer vehicles on the road means measurably cleaner air around every school.</p>
                                </div>
                                <div className="flex flex-col gap-3.5 p-5 rounded-[14px] border border-[rgba(23,105,56,0.15)] bg-white transition-all hover:-translate-y-1 hover:shadow-[0_1px_2px_rgba(14,27,22,0.04),_0_12px_32px_-12px_rgba(14,27,22,0.12)] hover:border-transparent">
                                    <div className="w-11 h-11 rounded-xl flex items-center justify-center bg-[rgba(213,240,219,0.4)] text-gosirat-green shrink-0">
                                    ...
                                    <h4 className="text-[15px] text-gosirat-black font-semibold leading-[1.1]">Less Congestion</h4>
                                    <p className="text-[13.5px] text-gosirat-gray leading-[1.55]">Shared routes stop the heavy traffic jams at school gates and on neighborhood streets, making drop-off times faster and safer for everyone.</p>
                                </div>
                                <div className="flex flex-col gap-3.5 p-5 rounded-[14px] border border-[rgba(23,105,56,0.15)] bg-white transition-all hover:-translate-y-1 hover:shadow-[0_1px_2px_rgba(14,27,22,0.04),_0_12px_32px_-12px_rgba(14,27,22,0.12)] hover:border-transparent">
                                    <div className="w-11 h-11 rounded-xl flex items-center justify-center bg-[rgba(213,240,219,0.4)] text-gosirat-green shrink-0">
                                    ...
                                    <h4 className="text-[15px] text-gosirat-black font-semibold leading-[1.1]">Safer Commutes</h4>
                                    <p className="text-[13.5px] text-gosirat-gray leading-[1.55]">Trained drivers and monitored vehicles keep every ride secure and tracked.</p>
                                </div>
                                <div className="flex flex-col gap-3.5 p-5 rounded-[14px] border border-[rgba(23,105,56,0.15)] bg-white transition-all hover:-translate-y-1 hover:shadow-[0_1px_2px_rgba(14,27,22,0.04),_0_12px_32px_-12px_rgba(14,27,22,0.12)] hover:border-transparent">
                                    <div className="w-11 h-11 rounded-xl flex items-center justify-center bg-[rgba(213,240,219,0.4)] text-gosirat-green shrink-0">
                                    ...
                                    <h4 className="text-[15px] text-gosirat-black font-semibold leading-[1.1]">Smarter Routing</h4>
                                    <p className="text-[13.5px] text-gosirat-gray leading-[1.55]">Our smart planning cuts out wasted time and extra miles from every trip, making each journey as efficient as possible.</p>
                                </div>
                            </div>
                        </div>

                        <div className="relative w-full max-w-[500px] xl:max-w-[600px] ml-auto mq825:mx-auto rounded-[28px] overflow-hidden shadow-[0_1px_2px_rgba(14,27,22,0.04),_0_12px_32px_-12px_rgba(14,27,22,0.12)] aspect-[4/5] mq825:aspect-[16/10] mq825:order-first" data-aos="fade-up" data-aos-delay="200">
                            <img
            ...
            <section className="bg-white py-[120px] lg:py-[80px] mq825:py-[60px] mq450:py-[50px]" id="impact">
                <div className="max-w-[1240px] mx-auto px-8 lg:px-6 mq450:px-4">
                    <div className="max-w-[640px] mx-auto text-center mb-14" data-aos="fade-up">
                        ...
                        <div className="w-full relative font-sans font-normal text-[20px] leading-[32.5px] tracking-normal text-center text-gosirat-gray mt-[19.7px]">
                    ...
                    <div className="grid grid-cols-2 mq825:grid-cols-1 gap-6">
                        <div className="bg-white rounded-[20px] p-9 mq825:p-6 shadow-[0_1px_2px_rgba(14,27,22,0.04),_0_12px_32px_-12px_rgba(14,27,22,0.12)] border border-transparent transition-all hover:-translate-y-1.5 hover:shadow-[0_1px_2px_rgba(14,27,22,0.05),_0_24px_48px_-16px_rgba(14,27,22,0.18)]" data-aos="fade-up">
                            <div className="w-[52px] h-[52px] rounded-[14px] flex items-center justify-center bg-[rgba(213,240,219,0.4)] text-gosirat-green mb-5.5">
                            ...
                            <h3 className="text-[19.5px] text-gosirat-black font-bold leading-[1.1] mb-2.5">Lower Carbon Emissions</h3>
                            <p className="text-[14.5px] text-gosirat-gray leading-[1.7]">Our smart routes and shared trips use less fuel and lower carbon emissions on every school run, mile after mile.</p>
                        </div>
                        <div className="bg-white rounded-[20px] p-9 mq825:p-6 shadow-[0_1px_2px_rgba(14,27,22,0.04),_0_12px_32px_-12px_rgba(14,27,22,0.12)] border border-transparent transition-all hover:-translate-y-1.5 hover:shadow-[0_1px_2px_rgba(14,27,22,0.05),_0_24px_48px_-16px_rgba(14,27,22,0.18)]" data-aos="fade-up" data-aos-delay="100">
                            <div className="w-[52px] h-[52px] rounded-[14px] flex items-center justify-center bg-[rgba(213,240,219,0.4)] text-gosirat-green mb-5.5">
                            ...
                            <h3 className="text-[19.5px] text-gosirat-black font-bold leading-[1.1] mb-2.5">Fuel-Efficient Fleet</h3>
                            <p className="text-[14.5px] text-gosirat-gray leading-[1.7]">Modern, well-maintained vehicles are engineered for lower consumption and cleaner combustion across every neighborhood route.</p>
                        </div>
                        <div className="bg-white rounded-[20px] p-9 mq825:p-6 shadow-[0_1px_2px_rgba(14,27,22,0.04),_0_12px_32px_-12px_rgba(14,27,22,0.12)] border border-transparent transition-all hover:-translate-y-1.5 hover:shadow-[0_1px_2px_rgba(14,27,22,0.05),_0_24px_48px_-16px_rgba(14,27,22,0.18)]" data-aos="fade-up" data-aos-delay="200">
                            <div className="w-[52px] h-[52px] rounded-[14px] flex items-center justify-center bg-[rgba(213,240,219,0.4)] text-gosirat-green mb-5.5">
                            ...
                            <h3 className="text-[19.5px] text-gosirat-black font-bold leading-[1.1] mb-2.5">Smart Route Optimization</h3>
                            <p className="text-[14.5px] text-gosirat-gray leading-[1.7]">Our smart system constantly updates routes to cut out extra miles and wasted time, making every trip as fast and efficient as possible.</p>
                        </div>
                        <div className="bg-white rounded-[20px] p-9 mq825:p-6 shadow-[0_1px_2px_rgba(14,27,22,0.04),_0_12px_32px_-12px_rgba(14,27,22,0.12)] border border-transparent transition-all hover:-translate-y-1.5 hover:shadow-[0_1px_2px_rgba(14,27,22,0.05),_0_24px_48px_-16px_rgba(14,27,22,0.18)]" data-aos="fade-up" data-aos-delay="300">
                            <div className="w-[52px] h-[52px] rounded-[14px] flex items-center justify-center bg-[rgba(213,240,219,0.4)] text-gosirat-green mb-5.5">
                            ...
                            <h3 className="text-[19.5px] text-gosirat-black font-bold leading-[1.1] mb-2.5">Community-Wide Reduction</h3>
                            <p className="text-[14.5px] text-gosirat-gray leading-[1.7]">Shared rides remove thousands of individual car trips from local roads and school gates every single week.</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="bg-gosirat-black text-white py-[120px] lg:py-[80px] mq825:py-[60px] mq450:py-[50px]" id="commitment">
                <div className="max-w-[1240px] mx-auto px-8 lg:px-6 mq450:px-4">
                    <div className="max-w-[640px] mx-auto text-center mb-14" data-aos="fade-up">
                        <div className="flex justify-center">
                            <div className="min-h-[29px] h-auto rounded-[30px] bg-gosirat-light/5 border-gosirat-light/20 border-solid border-[0.67px] box-border flex items-center py-[6px] px-[14px] gap-[8px]">
                        ...
                        <div className="w-full relative font-sans font-normal text-[20px] leading-[32.5px] tracking-normal text-center text-gosirat-light/80 mt-[19.7px]">
            ...
            <section className="bg-gosirat-bg-light py-[120px] lg:py-[80px] mq825:py-[60px] mq450:py-[50px]" id="stats">
                <div className="max-w-[1240px] mx-auto px-8 lg:px-6 mq450:px-4">
                    <div className="max-w-[640px] mx-auto text-center mb-14" data-aos="fade-up">
                        <div className="flex justify-center">
                            <div className="inline-flex rounded-[30px] bg-[rgba(213,240,219,0.4)] border-[rgba(23,105,56,0.15)] border-solid border-[0.67px] items-center py-[6px] px-[14px] gap-[8px]">
                    ...
                    <div className="grid grid-cols-5 lg:grid-cols-3 mq825:grid-cols-2 mq450:grid-cols-1 gap-[18px]">
                        <div className="bg-white border border-[rgba(23,105,56,0.15)] rounded-[20px] p-[32px_22px] mq825:p-5 text-center transition-all hover:-translate-y-1 hover:shadow-[0_1px_2px_rgba(14,27,22,0.04),_0_12px_32px_-12px_rgba(14,27,22,0.12)] hover:border-transparent relative" data-aos="fade-up">
                            <div className="w-[44px] h-[44px] rounded-xl flex items-center justify-center bg-[rgba(213,240,219,0.4)] text-gosirat-green mx-auto mb-[18px]">
                                <svg className="w-[22px] h-[22px]" viewBox="0 0 24 24" fill="none"><path d="M12 3C7 3 4 7 4 12c0 5 3.5 9 8 9s8-4 8-9c0-2-1-4-2-5" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" /><path d="M12 21V9" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" /></svg>
                            </div>
                            <div className="font-inherit font-extrabold text-[clamp(26px,2.4vw,32px)] text-gosirat-black leading-[1]">
                                12,400<span className="text-[0.55em] text-gosirat-green font-bold">+</span>
                            </div>
                            <div className="mt-2.5 text-[13px] text-gosirat-gray font-mono tracking-[0.02em]">Tons CO2 Avoided</div>
                        </div>
                        <div className="bg-white border border-[rgba(23,105,56,0.15)] rounded-[20px] p-[32px_22px] mq825:p-5 text-center transition-all hover:-translate-y-1 hover:shadow-[0_1px_2px_rgba(14,27,22,0.04),_0_12px_32px_-12px_rgba(14,27,22,0.12)] hover:border-transparent relative" data-aos="fade-up" data-aos-delay="100">
                            <div className="w-[44px] h-[44px] rounded-xl flex items-center justify-center bg-[rgba(213,240,219,0.4)] text-gosirat-green mx-auto mb-[18px]">
                            ...
                            <div className="font-inherit font-extrabold text-[clamp(26px,2.4vw,32px)] text-gosirat-black leading-[1]">
                                3.1<span className="text-[0.55em] text-gosirat-green font-bold">M km</span>
                            </div>
                            <div className="mt-2.5 text-[13px] text-gosirat-gray font-mono tracking-[0.02em]">Optimized Route Distance</div>
                        </div>
                        <div className="bg-white border border-[rgba(23,105,56,0.15)] rounded-[20px] p-[32px_22px] mq825:p-5 text-center transition-all hover:-translate-y-1 hover:shadow-[0_1px_2px_rgba(14,27,22,0.04),_0_12px_32px_-12px_rgba(14,27,22,0.12)] hover:border-transparent relative" data-aos="fade-up" data-aos-delay="200">
                            <div className="w-[44px] h-[44px] rounded-xl flex items-center justify-center bg-[rgba(213,240,219,0.4)] text-gosirat-green mx-auto mb-[18px]">
                            ...
                            <div className="font-inherit font-extrabold text-[clamp(26px,2.4vw,32px)] text-gosirat-black leading-[1]">
                                48,000<span className="text-[0.55em] text-gosirat-green font-bold">+</span>
                            </div>
                            <div className="mt-2.5 text-[13px] text-gosirat-gray font-mono tracking-[0.02em]">Car Trips Removed</div>
                        </div>
                        <div className="bg-white border border-[rgba(23,105,56,0.15)] rounded-[20px] p-[32px_22px] mq825:p-5 text-center transition-all hover:-translate-y-1 hover:shadow-[0_1px_2px_rgba(14,27,22,0.04),_0_12px_32px_-12px_rgba(14,27,22,0.12)] hover:border-transparent relative" data-aos="fade-up" data-aos-delay="300">
                            <div className="w-[44px] h-[44px] rounded-xl flex items-center justify-center bg-[rgba(213,240,219,0.4)] text-gosirat-green mx-auto mb-[18px]">
                                <svg className="w-[22px] h-[22px]" viewBox="0 0 24 24" fill="none"><circle cx="8" cy="9" r="2.6" stroke="currentColor" strokeWidth="1.8" /><circle cx="17" cy="9" r="2.2" stroke="currentColor" strokeWidth="1.8" /><path d="M3.5 19c.7-3 2.4-4.6 4.5-4.6s3.8 1.6 4.5 4.6" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" /><path d="M13.8 14.6c1.9.2 3.3 1.8 3.9 4.4" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" /></svg>
                            </div>
                            <div className="font-inherit font-extrabold text-[clamp(26px,2.4vw,32px)] text-gosirat-black leading-[1]">
                                26,500<span className="text-[0.55em] text-gosirat-green font-bold">+</span>
                            </div>
                            <div className="mt-2.5 text-[13px] text-gosirat-gray font-mono tracking-[0.02em]">Students Served Daily</div>
                        </div>
                        <div className="bg-white border border-[rgba(23,105,56,0.15)] rounded-[20px] p-[32px_22px] mq825:p-5 text-center transition-all hover:-translate-y-1 hover:shadow-[0_1px_2px_rgba(14,27,22,0.04),_0_12px_32px_-12px_rgba(14,27,22,0.12)] hover:border-transparent relative" data-aos="fade-up" data-aos-delay="400">
                            <div className="w-[44px] h-[44px] rounded-xl flex items-center justify-center bg-[rgba(213,240,219,0.4)] text-gosirat-green mx-auto mb-[18px]">
                            ...
                            <div className="font-inherit font-extrabold text-[clamp(26px,2.4vw,32px)] text-gosirat-black leading-[1]">
                                94<span className="text-[0.55em] text-gosirat-green font-bold">%</span>
                            </div>
                            <div className="mt-2.5 text-[13px] text-gosirat-gray font-mono tracking-[0.02em]">Fleet Efficiency Rating</div>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="bg-white py-[120px] lg:py-[80px] mq825:py-[60px] mq450:py-[50px]" id="global">
                <div className="w-full mx-auto px-8 lg:px-6 mq450:px-4">
                    <div className="grid grid-cols-2 mq825:grid-cols-1 gap-[72px] mq825:gap-[48px] items-center">
                        <div data-aos="fade-up">
                            ...
                            <ul className="flex flex-col gap-5 xl:gap-6 mt-4">
                                <li className="flex items-start gap-4 text-[15px] md:text-[17px] xl:text-[19px] text-gosirat-gray">
                                    <span className="w-2 h-2 xl:w-2.5 xl:h-2.5 rounded-full bg-gosirat-green mt-[7px] xl:mt-[9px] shrink-0"></span>
                        ...
                        <div className="relative w-full max-w-[600px] xl:max-w-[700px] ml-auto mq825:mx-auto rounded-[28px] aspect-[4/3] mq825:aspect-[16/10] overflow-hidden shadow-[0_1px_2px_rgba(14,27,22,0.04),_0_12px_32px_-12px_rgba(14,27,22,0.12)] bg-gradient-to-br from-[#0c140f] to-[#0A2F24]" data-aos="fade-up" data-aos-delay="200">
                            <img
            ...
            <section className="relative min-h-[560px] flex items-center justify-center text-center overflow-hidden" id="cta">
                ...
                <div className="relative z-10 max-w-[800px] px-6 text-white flex flex-col items-center" data-aos="fade-up">
                    ...
                    <div className="flex justify-center mt-[34px] mq450:w-full">
                        <Link href="/register" className="no-underline rounded-2xl bg-gradient-to-r from-gosirat-green to-[#2ecc71] flex items-center justify-center py-4 px-6 gap-[7px] cursor-pointer hover:shadow-lg hover:scale-[1.02] active:scale-95 transition-all duration-300 mq450:w-full">
                            <h3 className="m-0 relative text-[length:inherit] leading-5 font-medium font-[inherit] text-white">
                                Register Today
                            </h3>
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#F7F9F6" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M5 12h14M12 5l7 7-7 7" /></svg>
