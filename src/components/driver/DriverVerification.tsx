  ...
  <section className="w-full bg-[#0C140F] flex flex-col items-start py-[100px] px-[60px] box-border mq450:py-[65px] mq450:px-4 mq450:box-border">
   <section className="w-full flex flex-col items-start text-left text-xs text-[#F4F7F4] font-[Inter]">
    <div className="self-stretch flex flex-col items-start gap-2.5">
     ...
     <div className="self-stretch flex flex-col items-start pt-3 px-0 pb-0 text-[18px] text-[#F4F7F4]/70">
      <div className="max-w-[800px] relative font-[Inter] font-normal text-[18px] leading-[28px] tracking-[0px] inline-block">
