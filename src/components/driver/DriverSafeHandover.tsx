...
export const DriverSafeHandover = () => {
 return (
  <section className="self-stretch bg-gosirat-black flex flex-col items-center pt-[100px] pb-0 px-[60px] box-border max-w-full mq450:pt-[65px] mq450:pb-0 mq450:px-4 mq450:box-border overflow-hidden">
   <div className="w-full flex items-center justify-between gap-12 lg:flex-wrap-reverse">
    
    <div className="flex-1 flex flex-col items-start gap-6 min-w-[400px] mq450:min-w-full text-base-white pb-[100px] mq450:pb-[65px]">
     ...
     <p className="m-0 self-stretch relative font-sans font-normal text-[18px] leading-[28px] tracking-normal text-gosirat-light/70 max-w-[800px]">
    ...
    <div className="flex-1 min-w-[400px] flex justify-end self-end mq450:min-w-full mq450:justify-center">
     <Image
