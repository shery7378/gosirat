...
export const DriverSafeHandover = () => {
 return (
  <section className="self-stretch bg-[#0C140F] flex flex-col items-center py-[100px] px-[60px] box-border max-w-full mq450:py-[65px] mq450:px-4 mq450:box-border">
   <div className="w-full flex items-center justify-between gap-12 lg:flex-wrap-reverse">
    ...
    <div className="flex-1 flex flex-col items-start gap-6 min-w-[400px] mq450:min-w-full text-base-white">
     ...
     <p className="m-0 self-stretch relative font-[Inter] font-normal text-[18px] leading-[28px] tracking-[0px] text-[#F4F7F4]/70 max-w-[600px]">
