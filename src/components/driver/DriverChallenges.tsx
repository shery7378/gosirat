  ...
  <section className="self-stretch bg-base-white flex flex-col items-start py-[100px] px-[60px] mq450:py-[65px] mq450:px-4 mq450:box-border">
   <div className="self-stretch flex flex-col items-start">
    <section className="w-full flex flex-col items-start max-w-[768px] text-left text-xs text-[#0D6332] font-[Inter] mq450:max-w-full">
     ...
     <div className="self-stretch flex flex-col items-start pt-4 px-0 pb-0 text-[48px] text-[#0c140f]">
     ...
     <div className="self-stretch flex flex-col items-start pt-5 px-0 pb-0 text-[18px] text-[#57605b]">
      <div className="w-full relative font-[Inter] font-normal text-[18px] leading-[28px] tracking-[0px] inline-block">
    ...
    <section className="self-stretch flex flex-col items-start pt-12 px-0 pb-0 text-left text-lg text-[#09131a] font-[Inter]">
     <div className="self-stretch flex items-center flex-wrap content-center gap-4">
      <div className="h-[138.8px] flex-1 rounded-[22px] bg-[#fff] border-[rgba(0,0,0,0.6)] border-solid border-[0.7px] box-border flex flex-col items-start py-[27px] px-7 min-w-[353px] mq450:min-w-full" data-aos="fade-in" data-aos-delay="100">
       <div className="self-stretch flex flex-col items-start">
      ...
      <div className="h-[138.8px] flex-1 rounded-[22px] bg-[#fff] border-[rgba(0,0,0,0.6)] border-solid border-[0.7px] box-border flex flex-col items-start py-[27px] px-7 min-w-[353px] mq450:min-w-full" data-aos="fade-in" data-aos-delay="200">
       <div className="self-stretch flex flex-col items-start">
        <div className="relative tracking-[-0.45px] leading-7 font-semibold text-[#09131A]">
         Unstable Earnings
        </div>
      ...
      <div className="h-[138.8px] flex-1 rounded-[22px] bg-[#fff] border-[rgba(0,0,0,0.6)] border-solid border-[0.7px] box-border flex flex-col items-start py-[27px] px-7 min-w-[353px] mq450:min-w-full" data-aos="zoom-in" data-aos-delay="300">
       <div className="self-stretch flex flex-col items-start">
        <div className="relative tracking-[-0.45px] leading-7 font-semibold text-[#09131A]">
