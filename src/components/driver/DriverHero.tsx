 ...
 return (
  <section className="self-stretch overflow-hidden flex flex-col items-start pt-10 px-0 pb-5 box-border max-w-full mq450:pt-[26px] mq450:box-border">
   <div className="self-stretch flex items-center justify-between pt-0 px-[60px] pb-10 box-border gap-10 max-w-full flex-wrap mq825:px-[30px] mq450:px-4 mq450:pb-[52px]">
    <section className="flex flex-col items-start py-5 px-0 box-border max-w-full text-left text-xs text-[#176938] font-[Inter] flex-1 min-w-[300px] mq1050:min-w-full mq1050:items-center mq1050:text-center">
     <div className="w-full max-w-[657px] flex flex-col items-start gap-6 mq1050:items-center">
      <div className="w-full max-w-[706px] flex flex-col items-start shrink-0 mq1050:items-center">
       ...
       <div className="self-stretch flex flex-col items-start justify-center pt-7 px-0 pb-4 gap-4 text-left text-6xl text-[#0C140F] mq1050:items-center mq1050:text-center mq750:text-5xl mq450:text-4xl">
        <div className="self-stretch flex flex-col items-start justify-center mq1050:items-center">
         <h1 className="m-0 self-stretch relative font-[Inter] font-semibold text-[64px] leading-[100%] tracking-[0px] text-left text-[#0c140f] mq1050:text-center mq825:text-[51px] mq825:leading-[59px] mq450:text-[38px] mq450:leading-[44px]">
          Driver App for Safe School Transportation
         </h1>
        </div>
        <h3 className="m-0 self-stretch relative font-[Inter] font-normal text-[20px] leading-[32.5px] tracking-[0px] text-left text-[#57605b] mq1050:text-center mq450:text-base mq450:leading-[26px] mt-4 max-w-[800px]">
      ...
      <div className="flex items-center justify-start mq1050:justify-center gap-4 shrink-0 flex-wrap w-full">
       <button className="cursor-pointer [border:none] py-5 px-6 bg-gradient-to-r from-[#176938] to-[#2ecc71] rounded-2xl flex items-center justify-center gap-2 hover:shadow-lg hover:scale-[1.02] active:scale-95 transition-all duration-300 mq450:w-full">
       ...
       <button className="cursor-pointer border-[rgba(0,0,0,0.2)] border-solid border-[1px] py-5 px-[23px] bg-base-white rounded-2xl flex items-center justify-center hover:bg-[#e6e6e6] hover:border-[rgba(51,51,51,0.2)] hover:border-solid hover:hover:border-[1px] hover:box-border mq450:w-full">
