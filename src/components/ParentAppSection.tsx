...
const ParentAppSection: NextPage = () => {
  return (
    <section className="self-stretch flex bg-gosirat-light flex-col items-start p-[60px] box-border max-w-full gap-16 mq1125:p-[40px] mq825:py-[39px] mq825:px-[30px] mq825:box-border mq450:px-4 mq450:pt-[25px] mq450:pb-[25px] mq450:box-border" data-aos="zoom-in">
