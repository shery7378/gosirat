    ...
    return (
        <section className="self-stretch flex flex-col items-start py-[100px] px-[60px] mq825:py-[65px] mq825:px-[30px] mq450:px-4 box-border" data-aos="fade-in">
            <section className="self-stretch flex flex-col items-start gap-2.5 text-left text-xs text-gosirat-green font-sans">
                ...
                <div className="w-full relative font-sans font-normal text-[18px] leading-[28px] tracking-normal text-left text-gosirat-gray max-w-[800px] mt-[19.7px]">
            ...
            <div className="self-stretch flex flex-col items-start pt-16 px-0 pb-0 mq450:pt-[42px] mq450:box-border">
                <div className="self-stretch grid grid-cols-3 mq975:grid-cols-2 mq650:grid-cols-1 gap-5">
                    <section className="flex flex-col shadow-[0px_1px_2px_rgba(16,24,16,0.04),_0px_8px_24px_rgba(16,24,16,0.06)] rounded-[28px] bg-white border-[rgba(222,227,222,0.7)] border-solid border-[0.7px] p-8 text-left text-lg text-gosirat-black font-sans h-full w-full overflow-hidden">
                        <div className="flex gap-1 mb-4">
                            {[1, 2, 3, 4, 5].map((star) => (
                                <svg key={`star1-${star}`} className="w-6 h-6 text-gosirat-green fill-current" viewBox="0 0 24 24">
                        ...
                        <div className="self-stretch flex flex-col items-start pt-8 px-0 pb-0 text-base">
                            <div className="self-stretch border-[#e5e7eb] border-solid border-t-[0.7px] box-border flex flex-col items-start pt-5 px-0 pb-0">
                                ...
                                <div className="self-stretch flex flex-col items-start text-sm text-gosirat-gray">
                    ...
                    <section className="flex flex-col shadow-[0px_1px_2px_rgba(16,24,16,0.04),_0px_8px_24px_rgba(16,24,16,0.06)] rounded-[28px] bg-white border-[rgba(222,227,222,0.7)] border-solid border-[0.7px] p-8 text-left text-lg text-gosirat-black font-sans h-full w-full overflow-hidden">
                        <div className="flex gap-1 mb-4">
                            {[1, 2, 3, 4, 5].map((star) => (
                                <svg key={`star2-${star}`} className="w-6 h-6 text-gosirat-green fill-current" viewBox="0 0 24 24">
                                    <path d="M12 17.27L18.18 21L16.54 13.97L22 9.24L14.81 8.63L12 2L9.19 8.63L2 9.24L7.46 13.97L5.82 21L12 17.27Z" />
                                </svg>
                            ))}
                        </div>
                    ...
                    <section className="flex flex-col shadow-[0px_1px_2px_rgba(16,24,16,0.04),_0px_8px_24px_rgba(16,24,16,0.06)] rounded-[28px] bg-white border-[rgba(222,227,222,0.7)] border-solid border-[0.7px] p-8 text-left text-lg text-gosirat-black font-sans h-full w-full overflow-hidden">
                        <div className="flex gap-1 mb-4">
                            {[1, 2, 3, 4, 5].map((star) => (
                                <svg key={`star3-${star}`} className="w-6 h-6 text-gosirat-green fill-current" viewBox="0 0 24 24">
                                    <path d="M12 17.27L18.18 21L16.54 13.97L22 9.24L14.81 8.63L12 2L9.19 8.63L2 9.24L7.46 13.97L5.82 21L12 17.27Z" />
                                </svg>
                            ))}
                        </div>
