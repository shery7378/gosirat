...
const AppDownload: React.FC<AppDownloadProps> = ({
    ...
    return (
        <section className="w-full flex flex-col items-center py-16 px-[60px] box-border mq725:px-[30px] mq450:py-10 mq450:px-4 mx-auto" data-aos="zoom-in">
            <div className="w-full rounded-[24px] md:rounded-[40px] bg-gradient-to-b from-gosirat-green to-[#022913] overflow-hidden flex flex-col md:flex-row items-center justify-between relative box-border min-h-0 md:min-h-[464px]">
                ...
                <div className="flex flex-col gap-6 z-10 relative w-full md:w-[60%] min-[1050px]:w-[55%] items-start text-left py-12 px-6 sm:px-8 md:py-24 md:pl-12 md:pr-4 min-[1050px]:pl-16">
                    <div className="flex flex-col gap-4 w-full items-start">
                        <div className="inline-flex rounded-[30px] bg-gosirat-green-light border-[rgba(23,105,56,0.15)] border-solid border-[0.67px] items-center py-[6px] px-[14px] gap-[8px]" data-aos="fade-in" data-aos-delay="100">
                            <div className="h-[6px] w-[6px] relative rounded-full bg-gosirat-green-dark" />
                            <div className="relative font-sans font-medium text-[12px] leading-[16px] tracking-[1.68px] uppercase text-gosirat-green-dark">
                                {label}
                            </div>
                        </div>

                        <h2 className="m-0 mt-6 self-stretch relative font-sans font-semibold text-[48px] leading-none capitalize tracking-[-1.5px] text-left text-white mq825:text-[38px] mq825:leading-[48px] mq450:text-[24px] mq450:leading-[32px] break-words max-w-[550px]">
                            {heading}
                        </h2>

                        <div className="w-full relative font-sans font-normal text-[20px] leading-[32.5px] tracking-normal text-left text-[rgba(255,255,255,0.85)] max-w-[600px] mt-[19.7px]">
                            {description}
                        </div>
                    </div>
                    ...
                    <div className="flex items-center gap-4 flex-wrap w-full justify-center sm:justify-start mt-6">
                        {/* App Store Button */}
                        <a href="#" className="flex items-center justify-center gap-[10px] bg-black border border-black rounded-[14px] py-2 hover:bg-gosirat-dark-alt transition-colors h-[54px] w-[180px] no-underline">
