...
export const AboutStats = () => {
 return (
  <section className="self-stretch bg-gosirat-green flex flex-col items-center py-10 px-[60px] text-left text-6xl text-white font-sans mq450:px-4 mq450:box-border" data-aos="fade-in">
