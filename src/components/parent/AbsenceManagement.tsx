            ...
            <div className="w-full max-w-[580.3px] flex flex-col items-center justify-center relative isolate mq450:min-w-full mq450:flex-1">
                ...
                <div className="w-[398px] relative bg-white rounded-[24px] shadow-[0px_12px_24px_rgba(0,0,0,0.08)] border-2 border-solid border-[#176938]/30 p-6 flex flex-col gap-5 z-[1] shrink-0 font-[Inter] mq450:w-full" data-aos="fade-in" data-aos-delay="100">
                    ...
                    <div className="flex flex-col gap-1.5 mt-2">
                        <h3 className="m-0 text-xl font-bold text-[#202A32]">Will Ahmed be absent?</h3>
                    ...
                    <div className="flex flex-col gap-2">
                        <label className="text-[13px] font-semibold text-[#202A32]">Select Absent Duration</label>
                        <div className="flex gap-3">
                            ...
                            <button className="flex-1 py-2.5 bg-[#f4f7f4] border border-[#176938] rounded-[10px] text-[#176938] text-[13px] font-bold flex items-center justify-center gap-2 cursor-pointer">
                                <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                    ...
                    <div className="flex flex-col gap-2">
                        <label className="text-[13px] font-semibold text-[#202A32]">Select Duration</label>
                        <div className="flex gap-3">
                    ...
                    <div className="flex flex-col gap-2">
                        <label className="text-[13px] font-semibold text-[#202A32]">Select Reason</label>
                    ...
                    <button className="w-full py-3.5 bg-[#176938] hover:bg-[#12522b] text-white font-bold rounded-[10px] text-[14px] mt-2 transition-colors border-none cursor-pointer">
                        Confirm Absence
                    </button>
                </div>
