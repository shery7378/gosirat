export const HowItWorks = () => {
    return (
        <section className="w-full self-stretch bg-gosirat-black flex flex-col items-start py-[100px] px-[60px] box-border mq450:py-[65px] mq450:px-4 mq450:box-border" data-aos="zoom-in">
            <section className="w-full flex flex-col items-start text-left text-xs text-base-white font-sans">
                <div className="self-stretch flex flex-col items-start gap-2.5">
                    ...
                    <h2 className="m-0 self-stretch relative font-sans font-semibold text-[48px] leading-none capitalize tracking-[-1.5px] text-gosirat-light mq825:text-[38px] mq450:text-[24px] mq450:leading-[32px] break-words mt-4">
            ...
            <section className="w-full flex flex-col items-start py-5 px-0 box-border text-left text-[100px] text-base-white font-sans mt-10">
                <div className="self-stretch flex items-start justify-between gap-6 flex-wrap mq1125:justify-center mq750:flex-col mq750:items-stretch">
                    {/* Card 1 */}
                    <div className="group flex-1 min-w-[200px] flex flex-col items-start py-7 px-6 box-border mq750:w-full mq750:max-w-none rounded-2xl border border-transparent transition-all duration-300 ease-in-out transform hover:-translate-y-3 hover:bg-[#252c38] hover:border-gosirat-green/30 hover:shadow-[0_10px_30px_rgba(23,105,56,0.1)] cursor-pointer" data-aos="fade-out" data-aos-delay="200">
                        <h2 className="m-0 relative text-[length:inherit] font-semibold font-[inherit] text-[rgba(244,247,244,0.4)] group-hover:text-gosirat-green group-hover:scale-110 origin-left transition-all duration-300 mq450:text-[50px] mq450:text-3xl">
                            01
                        </h2>
                    ...
                    {/* Card 2 */}
                    <div className="group flex-1 min-w-[200px] flex flex-col items-start py-7 px-6 box-border mq750:w-full mq750:max-w-none rounded-2xl border border-transparent transition-all duration-300 ease-in-out transform hover:-translate-y-3 hover:bg-[#252c38] hover:border-gosirat-green/30 hover:shadow-[0_10px_30px_rgba(23,105,56,0.1)] cursor-pointer" data-aos="zoom-in" data-aos-delay="300">
                        <h2 className="m-0 relative text-[length:inherit] font-semibold font-[inherit] text-[rgba(244,247,244,0.4)] group-hover:text-gosirat-green group-hover:scale-110 origin-left transition-all duration-300 mq450:text-[50px] mq450:text-3xl">
                            02
                        </h2>
                        <div className="self-stretch flex flex-col items-start pt-6 px-0 pb-0 text-[28px]">
                    ...
                    {/* Card 3 */}
                    <div className="group flex-1 min-w-[200px] flex flex-col items-start py-7 px-6 box-border mq750:w-full mq750:max-w-none rounded-2xl border border-transparent transition-all duration-300 ease-in-out transform hover:-translate-y-3 hover:bg-[#252c38] hover:border-gosirat-green/30 hover:shadow-[0_10px_30px_rgba(23,105,56,0.1)] cursor-pointer" data-aos="fade-out" data-aos-delay="400">
                        <h2 className="m-0 relative text-[length:inherit] font-semibold font-[inherit] text-[rgba(244,247,244,0.4)] group-hover:text-gosirat-green group-hover:scale-110 origin-left transition-all duration-300 mq450:text-[50px] mq450:text-3xl">
                            03
                        </h2>
                        <div className="self-stretch flex flex-col items-start pt-6 px-0 pb-0 text-[28px]">
                    ...
                    {/* Card 4 */}
                    <div className="group flex-1 min-w-[200px] flex flex-col items-start py-7 px-6 box-border mq750:w-full mq750:max-w-none rounded-2xl border border-transparent transition-all duration-300 ease-in-out transform hover:-translate-y-3 hover:bg-[#252c38] hover:border-gosirat-green/30 hover:shadow-[0_10px_30px_rgba(23,105,56,0.1)] cursor-pointer" data-aos="fade-in" data-aos-delay="500">
                        <h2 className="m-0 relative text-[length:inherit] font-semibold font-[inherit] text-[rgba(244,247,244,0.4)] group-hover:text-gosirat-green group-hover:scale-110 origin-left transition-all duration-300 mq450:text-[50px] mq450:text-3xl">
                            04
                        </h2>
                        <div className="self-stretch flex flex-col items-start pt-6 px-0 pb-0 text-[28px]">
                    ...
                    {/* Card 5 */}
                    <div className="group flex-1 min-w-[200px] flex flex-col items-start py-7 px-6 box-border mq750:w-full mq750:max-w-none rounded-2xl border border-transparent transition-all duration-300 ease-in-out transform hover:-translate-y-3 hover:bg-[#252c38] hover:border-gosirat-green/30 hover:shadow-[0_10px_30px_rgba(23,105,56,0.1)] cursor-pointer" data-aos="fade-out" data-aos-delay="600">
                        <h2 className="m-0 relative text-[length:inherit] font-semibold font-[inherit] text-[rgba(244,247,244,0.4)] group-hover:text-gosirat-green group-hover:scale-110 origin-left transition-all duration-300 mq450:text-[50px] mq450:text-3xl">
                            05
                        </h2>
                        <div className="self-stretch flex flex-col items-start pt-6 px-0 pb-0 text-[28px]">
