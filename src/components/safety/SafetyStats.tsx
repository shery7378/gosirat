                ...
                <div className="mt-12 grid gap-4 grid-cols-6 mq1125:grid-cols-3 mq825:grid-cols-2 mq450:grid-cols-1">
                    {stats.map((stat) => (
                        <div key={stat.label} className="rounded-[16px] border border-[rgba(23,105,56,0.15)]/70 bg-white p-6 flex flex-col items-center justify-start text-center shadow-[0_4px_20px_rgb(0,0,0,0.02)]">
                            <div className="flex h-[38px] w-[38px] items-center justify-center rounded-[10px] bg-[rgba(213,240,219,0.4)]/70 text-gosirat-green">
                                <stat.Icon />
                            </div>
                            <p className="mt-5 text-[20px] font-bold font-inherit text-gosirat-black leading-tight">
                                {stat.value}
                            </p>
                            <p className="mt-3 text-[14px] font-medium font-inherit text-gosirat-gray leading-relaxed">
                                {stat.label}
                            </p>
                        </div>
                    ))}
