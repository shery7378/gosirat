    ...
    return (
        <section className="relative flex min-h-[85vh] items-center justify-center overflow-hidden text-white" data-aos="fade-in">
            ...
            <div className="relative z-10 max-w-4xl px-8 py-24 text-center mq825:px-6">
                <span className="inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/10 px-[14px] py-[6px] text-[12px] font-medium uppercase tracking-[1.68px] text-[#F8FBF8]">
                    <span className="h-[6px] w-[6px] rounded-full bg-gosirat-accent" />
                    GoSirat safety standards
                </span>
                <h1 className="mt-6 font-sans font-semibold text-[64px] leading-[100%] tracking-normal text-center text-white mq825:text-[51px] mq450:text-[38px]">
                ...
                <div className="mt-10 flex flex-wrap justify-center gap-4">
                    <Link href="/register" className="cursor-pointer border-none py-5 px-6 bg-gradient-to-r from-gosirat-green to-[#2ecc71] shadow-lg rounded-2xl flex items-center justify-center gap-[7px] hover:shadow-xl hover:-translate-y-1 hover:scale-[1.02] active:scale-95 no-underline transition-all duration-300 group">
